...
import { ALL_WORDS, EASY_WORDS } from "../js/data/words.js?v=20260803-d";
import { Logic, queryWordPair } from "../js/core/logic.js?v=20260803-d";
import { todayPID, isDailyPID, candidateWordsForPID, usesNewGenerator } from "../js/core/problems.js?v=20260803-d";
...
{
  const { CELL, usoConvert } = await import("../js/core/logic.js?v=20260803-d");
