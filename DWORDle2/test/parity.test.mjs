...
import { ALL_WORDS, EASY_WORDS } from "../js/data/words.js?v=20260725-a";
import { Logic, queryWordPair } from "../js/core/logic.js?v=20260725-a";
import { todayPID, isDailyPID, candidateWordsForPID } from "../js/core/problems.js?v=20260725-a";
...
{
  const { CELL, usoConvert } = await import("../js/core/logic.js?v=20260725-a");
