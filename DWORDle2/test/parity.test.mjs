...
import { ALL_WORDS, EASY_WORDS } from "../js/data/words.js?v=20260725-b";
import { Logic, queryWordPair } from "../js/core/logic.js?v=20260725-b";
import { todayPID, isDailyPID, candidateWordsForPID } from "../js/core/problems.js?v=20260725-b";
...
{
  const { CELL, usoConvert } = await import("../js/core/logic.js?v=20260725-b");
