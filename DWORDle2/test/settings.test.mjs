...
const { DEFAULT_SETTINGS, HIDDEN_THEMES, normalizeVolume } = await import("../js/core/settings.js?v=20260725-b");
const { shouldReduceMotion } = await import("../js/core/motion.js?v=20260725-b");
