...
const { DEFAULT_SETTINGS, HIDDEN_THEMES, normalizeVolume } = await import("../js/core/settings.js?v=20260806-a");
const { shouldReduceMotion } = await import("../js/core/motion.js?v=20260806-a");
