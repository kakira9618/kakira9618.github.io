...
try {
  ...
  await page.evaluate(async () => {
    const { setAppMode } = await import("./js/ui/app.js?v=20260722-card-refine");
    setAppMode("uso");
  });
  ...
  await page.evaluate(async () => {
    const { showHelpModal } = await import("./js/ui/help.js?v=20260722-card-refine");
  ...
  const flightsBeforeLeave = await shortPage.evaluate(async () =>
    (await import("./js/fx/effects.js?v=20260722-card-refine")).activeTileFlightCount()
  );
  ...
  await page.evaluate(async () => {
    const { bgmUnlockCelebration } = await import("./js/ui/toast.js?v=20260722-card-refine");
  ...
  await page.evaluate(async () => {
    const { achievementCelebration } = await import("./js/ui/toast.js?v=20260722-card-refine");
  ...
  await page.evaluate(async () => {
    const { setSetting } = await import("./js/core/settings.js?v=20260722-card-refine");
  ...
  try {
    ...
    const ranks = await cardPage.evaluate(async () => {
      const mod = await import("./js/ui/player-card.js?v=20260722-card-refine");
      const pick = (stats) => {
