...
try {
  ...
  await page.evaluate(async () => {
    const { setAppMode } = await import("./js/ui/app.js?v=20260722-pop-locale-scale");
    setAppMode("uso");
  });
  ...
  await page.evaluate(async () => {
    const { showHelpModal } = await import("./js/ui/help.js?v=20260722-pop-locale-scale");
  ...
  const flightsBeforeLeave = await shortPage.evaluate(async () =>
    (await import("./js/fx/effects.js?v=20260722-pop-locale-scale")).activeTileFlightCount()
  );
  ...
  await page.evaluate(async () => {
    const { bgmUnlockCelebration } = await import("./js/ui/toast.js?v=20260722-pop-locale-scale");
  ...
  await page.evaluate(async () => {
    const { achievementCelebration } = await import("./js/ui/toast.js?v=20260722-pop-locale-scale");
