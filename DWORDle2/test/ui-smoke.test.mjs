...
try {
  ...
  await page.evaluate(async () => {
    const { setAppMode } = await import("./js/ui/app.js?v=20260722-unlock-analysis");
    setAppMode("uso");
  });
  ...
  await page.evaluate(async () => {
    const { showHelpModal } = await import("./js/ui/help.js?v=20260722-unlock-analysis");
  ...
  const flightsBeforeLeave = await shortPage.evaluate(async () =>
    (await import("./js/fx/effects.js?v=20260722-unlock-analysis")).activeTileFlightCount()
  );
  ...
  await page.evaluate(async () => {
    const { bgmUnlockCelebration } = await import("./js/ui/toast.js?v=20260722-unlock-analysis");
  ...
  await page.evaluate(async () => {
    const { achievementCelebration } = await import("./js/ui/toast.js?v=20260722-unlock-analysis");
