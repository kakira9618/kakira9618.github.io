...
const { Logic, CELL, queryWordSingle, displayResultForMode } = await import("../js/core/logic.js?v=20260803-a");
...
const { DEFAULT_SETTINGS, getSettings, setSetting } = await import("../js/core/settings.js?v=20260803-a");
const es = await import("../js/core/extra-shot.js?v=20260803-a");
const { tryEnableDebugMode } = await import("../js/core/debug.js?v=20260803-a");
// 隠し要素の文字列はテストにも平文で置かない（js/core/secret.js 参照）
const { reveal } = await import("../js/core/secret.js?v=20260803-a");
