...
const { Logic, CELL, queryWordSingle, displayResultForMode } = await import("../js/core/logic.js?v=20260806-a");
...
const { DEFAULT_SETTINGS, getSettings, setSetting } = await import("../js/core/settings.js?v=20260806-a");
const es = await import("../js/core/extra-shot.js?v=20260806-a");
const { tryEnableDebugMode } = await import("../js/core/debug.js?v=20260806-a");
