...
const { ACHIEVEMENTS, getUnlocked } = await import("../js/core/achievements.js?v=20260803-b");
const { getSettings, setSetting } = await import("../js/core/settings.js?v=20260803-b");
const { isDebugMode, tryEnableDebugMode } = await import("../js/core/debug.js?v=20260803-b");
// キーワードはソースの全文検索に出ないよう符号化して持つ（js/core/secret.js と同じ方針）
const { reveal } = await import("../js/core/secret.js?v=20260803-b");
const { loadJSON, removeKey, saveJSON } = await import("../js/core/store.js?v=20260803-b");
