...
const { scanLegacyHistory, importFromLocalStorage } = await import("../js/core/migrate.js?v=20260725-a");
const { getHistory } = await import("../js/core/records.js?v=20260725-a");
const { achievementIdsFromHistory } = await import("../js/core/achievements.js?v=20260725-a");
...
{
  const { addImportedGames } = await import("../js/core/records.js?v=20260725-a");
...
{
  const { addFinishedGame, countPlays } = await import("../js/core/records.js?v=20260725-a");
