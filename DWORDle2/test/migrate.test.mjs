...
const { scanLegacyHistory, importFromLocalStorage } = await import("../js/core/migrate.js?v=20260803-b");
const { getHistory } = await import("../js/core/records.js?v=20260803-b");
const { achievementIdsFromHistory } = await import("../js/core/achievements.js?v=20260803-b");
...
{
  const { addImportedGames } = await import("../js/core/records.js?v=20260803-b");
...
{
  const { importFromText } = await import("../js/core/migrate.js?v=20260803-b");
...
{
  const { importFromText } = await import("../js/core/migrate.js?v=20260803-b");
  const { MODES } = await import("../js/core/records.js?v=20260803-b");
  const before = getHistory().length;
...
{
  const { importFromText } = await import("../js/core/migrate.js?v=20260803-b");
  const { CELL } = await import("../js/core/logic.js?v=20260803-b");
...
{
  const { addFinishedGame, countPlays } = await import("../js/core/records.js?v=20260803-b");
