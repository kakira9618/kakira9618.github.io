...
const { scanLegacyHistory, importFromLocalStorage } = await import("../js/core/migrate.js?v=20260803-c");
const { getHistory } = await import("../js/core/records.js?v=20260803-c");
const { achievementIdsFromHistory } = await import("../js/core/achievements.js?v=20260803-c");
...
{
  const { addImportedGames } = await import("../js/core/records.js?v=20260803-c");
...
{
  const { importFromText } = await import("../js/core/migrate.js?v=20260803-c");
  const { MODES } = await import("../js/core/records.js?v=20260803-c");
  const before = getHistory().length;
...
{
  const { importFromText } = await import("../js/core/migrate.js?v=20260803-c");
  const { CELL } = await import("../js/core/logic.js?v=20260803-c");
...
{
  const { addFinishedGame, countPlays } = await import("../js/core/records.js?v=20260803-c");
