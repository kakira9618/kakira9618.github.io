...
const { scanLegacyHistory, importFromLocalStorage } = await import("../js/core/migrate.js?v=20260728-a");
const { getHistory } = await import("../js/core/records.js?v=20260728-a");
const { achievementIdsFromHistory } = await import("../js/core/achievements.js?v=20260728-a");
...
{
  const { addImportedGames } = await import("../js/core/records.js?v=20260728-a");
...
{
  const { importFromText } = await import("../js/core/migrate.js?v=20260728-a");
...
{
  const { importFromText } = await import("../js/core/migrate.js?v=20260728-a");
  const { MODES } = await import("../js/core/records.js?v=20260728-a");
  const before = getHistory().length;
...
{
  const { importFromText } = await import("../js/core/migrate.js?v=20260728-a");
  const { CELL } = await import("../js/core/logic.js?v=20260728-a");
...
{
  const { addFinishedGame, countPlays } = await import("../js/core/records.js?v=20260728-a");
