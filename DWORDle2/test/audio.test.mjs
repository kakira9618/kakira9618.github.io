...
const { AUDIO } = await import("../js/config.js?v=20260803-a");
const { setSetting } = await import("../js/core/settings.js?v=20260803-a");
const { audioNeedsRecovery, currentBgmTrackId, playSfx, rewindBgm, scheduleAudioRecovery, unlockAudio, setUsoMood, startBgm, stopBgm, BGM_TRACKS } = await import("../js/audio/sound.js?v=20260803-a");
...
{
  const { getActivity } = await import("../js/core/activity.js?v=20260803-a");
