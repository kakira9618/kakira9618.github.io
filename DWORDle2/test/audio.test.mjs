...
const { audioNeedsRecovery, currentBgmTrackId, playSfx, rewindBgm, scheduleAudioRecovery, unlockAudio, setUsoMood, startBgm, stopBgm, BGM_TRACKS } = await import("../js/audio/sound.js?v=20260803-d");
...
{
  const { getActivity } = await import("../js/core/activity.js?v=20260803-d");
