...
import { Logic, CELL, queryWordSingle } from "./logic.js?v=20260728-a";
import { isDailyPID } from "./problems.js?v=20260728-a";
import { signatureAvailable, signPayload } from "./signature.js?v=20260728-a";
