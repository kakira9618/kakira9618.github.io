...
import { loadJSON, saveJSON, onExternalChange } from "./store.js?v=20260803-a";
import { isClassicPID, isDailyPID, NEW_ERA, PID, problemNumber } from "./problems.js?v=20260803-a";
import { getHistory, getExtraShot, MODES } from "./records.js?v=20260803-a";
import { CELL, Logic } from "./logic.js?v=20260803-a";
import { isDebugMode } from "./debug.js?v=20260803-a";
import { reveal } from "./secret.js?v=20260803-a";
import { MARK, signAchievement, verifyAchievementMark } from "./achievement-mark.js?v=20260803-a";
