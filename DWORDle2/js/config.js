...
export const AUDIO = {
  ...
  // BGM 再生中に出し続ける、耳に聞こえない極小信号。
  // 生成 BGM は拍や小節の変わり目に 100ms 前後の完全な無音ができる。デジタル無音が続くと
  // iOS Safari は「再生が止まった」と判断し、鳴り直すたびにアドレスバーの再生中アイコンを
  // 出し直す（点滅して見える）。この信号で出力を途切れさせない。
  // 30Hz / -70dBFS 相当なのでスピーカーからは聞こえない。
  keepAliveHz: 30,
  keepAliveGain: 0.0003,
