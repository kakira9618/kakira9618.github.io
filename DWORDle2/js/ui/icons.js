...
const ICONS = {
  ...
  // 365 日の奇跡: 破線の軌道 +（軌跡を描く）星
  starTrail: '<path d="M12 2a10 10 0 1 1-8.7 5.1" stroke-dasharray="2.4 3"/><path d="m12 5.8 2 4.5 4.9.4-3.7 3.2 1.1 4.8-4.3-2.6-4.3 2.6 1.1-4.8-3.7-3.2 4.9-.4Z"/>',
  // DOUBLE CLEAR 系（他の実績と被らない専用アイコン）
  twinHearts: '<path d="M7 18.5s-4.5-3.2-4.5-6.2A2.5 2.5 0 0 1 7 10.6a2.5 2.5 0 0 1 4.5 1.7c0 3-4.5 6.2-4.5 6.2Z"/><path d="M16.5 13.4s-4.5-3.2-4.5-6.2a2.5 2.5 0 0 1 4.5-1.7 2.5 2.5 0 0 1 4.5 1.7c0 3-4.5 6.2-4.5 6.2Z"/>',
  binoculars: '<rect x="2.5" y="9.5" width="7" height="11" rx="3.5"/><rect x="14.5" y="9.5" width="7" height="11" rx="3.5"/><path d="M9.5 14h5M6 9.5V5.6a1.6 1.6 0 0 1 3.2 0v3.9M14.8 9.5V5.6a1.6 1.6 0 0 1 3.2 0v3.9"/>',
  comet: '<circle cx="17" cy="7" r="3"/><path d="M13.6 10.4 3.2 20.8M12.6 6.4 7.2 11.8M17.6 11.4l-5.4 5.4"/>',
  doubleCheck: '<path d="m2.5 12.8 3.8 3.8 6.4-7.4"/><path d="m10.2 15.6 2.4 2.4 8.9-10.2"/>',
  spiral: '<path d="M12.4 12.6a1.9 1.9 0 1 0 1.6-2.9c-2.3 0-3.9 1.9-3.9 4.2s2 4.2 4.5 4.2 4.9-2.3 4.9-5.2-2.6-5.6-6-5.6-6.5 2.8-6.5 6.4"/>',
  chain: '<path d="m9.4 14.6 5.2-5.2"/><path d="m13.1 6.9 1.5-1.5a3.6 3.6 0 0 1 5.1 5.1l-1.5 1.5M10.9 17.1l-1.5 1.5a3.6 3.6 0 0 1-5.1-5.1l1.5-1.5"/>',
};
