...
import { getSettings, setSetting, HIDDEN_THEMES } from "../core/settings.js?v=20260722-card-refine";
...
import { getUnlocked } from "../core/achievements.js?v=20260722-card-refine";
import { BGM_TRACKS, playSfx } from "../audio/sound.js?v=20260722-card-refine";
import { toast } from "./toast.js?v=20260722-card-refine";
import { showModal, confirmModal } from "./modal.js?v=20260722-card-refine";
...
import { currentLanguage, isEnglish, syncDocumentLanguage, tr } from "../core/i18n.js?v=20260722-card-refine";
