...
import { registerScreen, navigate, setViewMood } from "./app.js?v=20260723-lang-bgm";
import { findGame, MODES } from "../core/records.js";
import { Logic } from "../core/logic.js";
import { pidLabel } from "../core/problems.js";
import { computeTruePatternIds, resultToPatternId, patternIdToStates } from "../core/analysis-core.js?v=20260723-lang-bgm";
import { checkOnEvent } from "../core/achievements.js?v=20260723-lang-bgm";
import { achievementCelebration } from "./toast.js?v=20260723-lang-bgm";
...
import { currentLanguage, isEnglish, tr } from "../core/i18n.js?v=20260723-lang-bgm";
import { rowAriaLabel } from "./a11y.js?v=20260723-lang-bgm";
...
function render(args) {
  ...
  worker = new Worker(new URL("../core/analysis.worker.js?v=20260723-lang-bgm", import.meta.url), { type: "module" });
  worker.onmessage = (e) => {
