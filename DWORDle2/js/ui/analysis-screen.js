...
import { findGame, MODES } from "../core/records.js?v=20260725-b";
import { Logic } from "../core/logic.js?v=20260725-b";
import { pidLabel } from "../core/problems.js?v=20260725-b";
import { computeTruePatternIds, resultToPatternId, patternIdToStates } from "../core/analysis-core.js?v=20260725-b";
import { checkOnEvent } from "../core/achievements.js?v=20260725-b";
import { achievementCelebration } from "./toast.js?v=20260725-b";
...
import { currentLanguage, isEnglish, tr } from "../core/i18n.js?v=20260725-b";
import { rowAriaLabel } from "./a11y.js?v=20260725-b";
...
function render(args) {
  ...
  worker = new Worker(new URL("../core/analysis.worker.js?v=20260725-b", import.meta.url), { type: "module" });
  worker.onmessage = (e) => {
