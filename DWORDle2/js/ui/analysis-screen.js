...
import { computeTruePatternIds, resultToPatternId, patternIdToStates } from "../core/analysis-core.js?v=20260722-pop-locale-scale";
import { checkOnEvent } from "../core/achievements.js?v=20260722-pop-locale-scale";
import { achievementCelebration } from "./toast.js?v=20260722-pop-locale-scale";
import { playSfx } from "../audio/sound.js?v=20260722-pop-locale-scale";
import { icon } from "./icons.js";
import { currentLanguage, isEnglish, tr } from "../core/i18n.js?v=20260722-pop-locale-scale";
...
function render(args) {
  ...
  worker = new Worker(new URL("../core/analysis.worker.js?v=20260722-pop-locale-scale", import.meta.url), { type: "module" });
  worker.onmessage = (e) => {
