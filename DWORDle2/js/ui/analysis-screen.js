...
import { computeTruePatternIds, resultToPatternId, patternIdToStates } from "../core/analysis-core.js?v=20260723-entry-gate";
import { checkOnEvent } from "../core/achievements.js?v=20260723-entry-gate";
import { achievementCelebration } from "./toast.js?v=20260723-entry-gate";
...
import { currentLanguage, isEnglish, tr } from "../core/i18n.js?v=20260723-entry-gate";
...
function render(args) {
  ...
  worker = new Worker(new URL("../core/analysis.worker.js?v=20260723-entry-gate", import.meta.url), { type: "module" });
  worker.onmessage = (e) => {
