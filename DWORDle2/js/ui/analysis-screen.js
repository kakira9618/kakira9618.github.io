...
import { computeTruePatternIds, resultToPatternId, patternIdToStates } from "../core/analysis-core.js?v=20260722-habit-ui";
import { checkOnEvent } from "../core/achievements.js?v=20260722-habit-ui";
import { achievementCelebration } from "./toast.js?v=20260722-habit-ui";
...
function render(args) {
  ...
  worker = new Worker(new URL("../core/analysis.worker.js?v=20260722-habit-ui", import.meta.url), { type: "module" });
  worker.onmessage = (e) => {
