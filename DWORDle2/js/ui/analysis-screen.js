...
import { computeTruePatternIds, resultToPatternId, patternIdToStates } from "../core/analysis-core.js?v=20260722-bgm-ui-refresh";
import { checkOnEvent } from "../core/achievements.js?v=20260722-bgm-ui-refresh";
import { achievementCelebration } from "./toast.js?v=20260722-bgm-ui-refresh";
...
import { currentLanguage, isEnglish, tr } from "../core/i18n.js?v=20260722-bgm-ui-refresh";
...
function render(args) {
  ...
  worker = new Worker(new URL("../core/analysis.worker.js?v=20260722-bgm-ui-refresh", import.meta.url), { type: "module" });
  worker.onmessage = (e) => {
