...
import { APP_VERSION, UI, FX } from "../config.js?v=20260722-monthly-vow";
...
import { checkOnGameFinish } from "../core/achievements.js?v=20260722-monthly-vow";
import { registerScreen, navigate, redirect, getAppMode, currentScreenName, rememberPlayedMode } from "./app.js?v=20260722-monthly-vow";
import { toast, achievementCelebration, bgmUnlockCelebration, themeUnlockCelebration } from "./toast.js?v=20260722-monthly-vow";
import { bgmTracksUnlockedBy, playSfx } from "../audio/sound.js?v=20260722-monthly-vow";
import { hiddenThemesUnlockedBy } from "../core/settings.js?v=20260722-monthly-vow";
import { burstAtElement, cancelTileFlights, winBurst, colorForState, flyInTiles } from "../fx/effects.js?v=20260722-monthly-vow";
import { showHelpModal } from "./help.js?v=20260722-monthly-vow";
...
import { getSettings } from "../core/settings.js?v=20260722-monthly-vow";
import { shouldReduceMotion } from "../core/motion.js?v=20260722-monthly-vow";
import { announce, feedbackName, rowAriaLabel, tileAriaLabel } from "./a11y.js?v=20260722-monthly-vow";
...
export async function confirmAndStart(pid, mode) {
  ...
  if (isAlreadyPlayed(pid, mode) || playedToday) {
    ...
    const { confirmModal } = await import("./modal.js?v=20260722-monthly-vow");
