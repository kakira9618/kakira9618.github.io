...
import { registerScreen, navigate, getAppMode, setAppMode } from "./app.js?v=20260722-card-refine";
...
import { getSettings, setSetting } from "../core/settings.js?v=20260722-card-refine";
...
import { finishHistoryImport } from "./history-import.js?v=20260722-card-refine";
import { showFirstTutorial, showHelpModal } from "./help.js?v=20260722-card-refine";
...
import { burstAtElement } from "../fx/effects.js?v=20260722-card-refine";
import { shouldReduceMotion } from "../core/motion.js?v=20260722-card-refine";
import { icon } from "./icons.js";
import { APP_VERSION } from "../config.js?v=20260722-card-refine";
import { localizedLevel, tr } from "../core/i18n.js?v=20260722-card-refine";
import { CARD_UNLOCK_PLAYS } from "./player-card.js?v=20260722-card-refine";
