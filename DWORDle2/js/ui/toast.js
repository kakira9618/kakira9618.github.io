...
import { UI } from "../config.js?v=20260725-b";
import { playSfx } from "../audio/sound.js?v=20260725-b";
import { winBurst } from "../fx/effects.js?v=20260725-b";
import { icon } from "./icons.js?v=20260725-b";
import { setSetting } from "../core/settings.js?v=20260725-b";
import { isEnglish, localizedAchievement, tr } from "../core/i18n.js?v=20260725-b";
