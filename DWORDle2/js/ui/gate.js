...
import { getAppMode } from "./app.js?v=20260803-d";
import { APP_VERSION } from "../config.js?v=20260803-d";
import { SOURCE_HASH } from "../version.js?v=20260803-d";
import { playSfx, rewindBgm, unlockAudio } from "../audio/sound.js?v=20260803-d";
import { muteAllSounds, unmuteAllSounds } from "./sound-toggle.js?v=20260803-d";
