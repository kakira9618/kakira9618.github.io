...
// 「開始」は音無し状態からでも音を復帰させ、「音無しで開始」は音を止めたまま入る。
// 初回訪問でも「いきなり基本ルールモーダル」ではなく、まず扉絵で迎える体裁になる。

import { el } from "./dom.js";
import { getAppMode } from "./app.js?v=20260723-gate-mode";
import { APP_VERSION } from "../config.js?v=20260723-gate-mode";
import { SOURCE_HASH } from "../version.js?v=20260723-gate-mode";
import { unlockAudio } from "../audio/sound.js?v=20260723-gate-mode";
import { muteAllSounds, unmuteAllSounds } from "./sound-toggle.js?v=20260723-gate-mode";
